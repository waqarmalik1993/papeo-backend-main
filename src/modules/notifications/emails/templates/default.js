module.exports = (title, body) => {
  ...
  <mj-body background-color="#F2F2F2">
    <mj-section padding="10px 0 20px 0">
      <mj-column>
        <mj-text align="center" color="#25233D" font-size="11px">${title}</mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section padding="20px 20px 0 20px" background-color="#FFFFFF">
      <mj-column>
        <mj-text align="center" font-weight="500" padding="0px 40px 10px 40px" font-size="32px" line-height="40px" color="#25233D">${title}</mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="#25233D">
      <mj-column width="100%">
        ...
        <mj-text color="#fff" align="center" padding="20px 40px 0 40px" font-weight="500" padding-bottom="100px" padding-top="20px"> </mj-text>
      </mj-column>
    </mj-section>
